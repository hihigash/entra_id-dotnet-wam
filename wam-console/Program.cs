...
namespace iwa_console
{
    ...
    class Program
    {
        ...
        private static async Task RunAsync()
        {
            ...
            var app = PublicClientApplicationBuilder.CreateWithApplicationOptions(appConfig).WithBroker(new BrokerOptions(BrokerOptions.OperatingSystems.Windows)).Build();
