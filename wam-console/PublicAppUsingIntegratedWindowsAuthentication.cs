...
namespace iwa_console
{
    ...
    public class PublicAppUsingIntegratedWindowsAuthentication
    {
        ...
        public async Task<AuthenticationResult> AcquireTokenFromWebAccountManagerAsync(IEnumerable<String> scopes)
        {
            ...
            try
            {
                result = await App.AcquireTokenSilent(scopes, accountToLogin).ExecuteAsync();
            }
